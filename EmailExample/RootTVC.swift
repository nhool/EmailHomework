...
class RootTVC: UITableViewController {
    ...
    var dataDelegate: DataUpdateDelegate?
    var context = ""
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            dataDelegate?.update(action: "delete", context: context, email: deletedEmail, indexPath: indexPath)
            tableView.deleteRows(at: [indexPath], with: .fade)
        }
    }
    
    func sendEmail() {
        let newEmail = Email(sender: "sender", subject: "string", contents: "contents")
        dataDelegate?.addEmail(email: newEmail)
